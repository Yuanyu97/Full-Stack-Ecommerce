...
exports.list = (req, res) => {
    ...
    let sortBy = req.query.sortBy ? req.query.sortBy : '_id' //sort by id by default
...
exports.listRelated = (req, res) => {
    ...
    Product.find({ _id: { $ne: req.product }, category: req.product.category }) // find all products related except for the one provided
        .select('-photo')
        .limit(limit)
